...
import { newProductSchema, updateProductSchema, searchQuerySchema } from "../models/product.models.js";
...
productRoutes.get("/products/search", celebrate({[Segments.QUERY]: searchQuerySchema}), asyncHandler(ProductsController.search)); // Precedencia de rotas
